...
- View [dtnprint.rs:L11-L28](../src/bin/dtnprint.rs#L11-L28) or [dtnsend.rs:L14-L49](../src/bin/dtnsend.rs#L14-L49) for examples of `Args` clap definitions.
...
- **`stdout`**: Reserved exclusively for functional outputs like printed bundle payloads, serialized bundle CBOR hex strings, and resulting bundle IDs.
